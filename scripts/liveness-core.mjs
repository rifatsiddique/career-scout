/**
 * liveness-core.mjs — Job posting liveness classifier
 *
 * Pure function module — no file I/O, no dependencies.
 * Used by check-liveness.mjs (CLI) and modes/scan.md (stale check agent step).
 *
